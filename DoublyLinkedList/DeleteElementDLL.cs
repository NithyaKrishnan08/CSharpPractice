...
public class DoublyLinkedList
{
    ...
    public void DeleteElementDLL(Node temp) // Node cannot be head
    {
        Node prev = temp.back;
        Node front = temp.next;
        
        if(front == null) // tail element
        {
            prev.next = null;
            temp.back = null;
        }
...
class Program
{
    static void Main()
    {
        ...
        doublyLinkedList.DeleteElementDLL(head.next.next);
        
        Console.WriteLine($"Deleting the given node of the doubly linked list");
