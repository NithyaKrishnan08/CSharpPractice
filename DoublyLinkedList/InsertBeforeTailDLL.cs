...
Inserting the given value before the tail of the doubly linked list
12
5
8
7
...
// Insertion of the given value before the tail of the doubly linked list
...
class Program
{
    static void Main()
    {
        ...
        Node newHead = doublyLinkedList.InsertBeforeTailDLL(head, value);
        
        Console.WriteLine($"Inserting the given value before the tail of the doubly linked list");
