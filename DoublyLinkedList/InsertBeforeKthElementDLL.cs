...
Inserting the given value before the 4th element of the doubly linked list
12
5
8
10
...
// Insertion of the given value before the kth position of the doubly linked list
...
class Program
{
    static void Main()
    {
        ...
        Node newHead = doublyLinkedList.InsertBeforeKthElementDLL(head, k, value);
        
        Console.WriteLine($"Inserting the given value before the {k}th element of the doubly linked list");
